...
Tutorial 1: RECOBMINE selects unbiased marker panel from scRNA-seq data for targeted spatial transcriptomics (https://github.com/korkutlab/recombine/blob/main/inst/tutorials/mvc_scRNA_spatial/mvc_scRNA_spatial.md)

Tutorial 2: RECOMBINE identifies recurrent composite markers for common and rare cell subpopulations of mouse intestinal organoids (https://github.com/korkutlab/recombine/blob/main/inst/tutorials/intestine_scRNA/intestine_scRNA.md)
